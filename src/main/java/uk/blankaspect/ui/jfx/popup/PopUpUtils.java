...
////////////////////////////////////////////////////////////////////////
	 ...
	 *           pop-up is displayed.
	 * @return a locator for the pop-up.
	 */
	 ...
	 * that is created and returned by this method.  The pop-up is located by aligning the specified reference position
	 * of the pop-up with the specified reference position of the target node.
	 *
	 * @param  target
	 ...
	 *           calculated from {@code targetPos} and {@code popUpPos}.  If it is {@code NaN}, the <i>y</i> coordinate
	 *           of the pop-up will be adjusted to keep the pop-up within the vertical extent of the screens.
	 * @return the pop-up manager argument, {@code popUpManager}.
	 */
